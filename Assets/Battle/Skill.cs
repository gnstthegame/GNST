...
public class Skill {/*
    ...
    public Skill(Vector2[] AtackArea, Vector2 Damage, int cost = 0, int Moment = 1, Effect Efect = null, bool Positive = false, int Range = 0, string AnimationTriggerName = "Dash") {
        Area = AtackArea;
        Dmg = Damage;
        Cost = cost;
        efect = Efect;
